...
namespace FinalProject_Truesdell
{
    class Hero
    { 
    ...
    public Hero(string name, string nemesis, string race, string power, bool antihero)
    {
        ...
        public Hero(string name, string nemesis, s string power, bool antihero)
        {
            this.Name = name;
            this.nemesis = nemesis;
            this.Race = race;
        ...
        public void FightCrime(string address)
    {
            ...
            if (PowerLevel > 49)
                {
                Console.WriteLine("Succesfully fought crime at " + address);
                }
    }
    ...
    private bool Investigate()
    {
        ...
        return returnValue;
            if (true)
            {
                Console.WriteLine("Investiagted Crime");
            }
